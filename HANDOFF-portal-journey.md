...
| `checkpoint-first-skill.html` · `checkpoint-system.html` · `checkpoint-autonomy.html` | CP2 / CP3 / CP4. Built from the template; steps mirror the board's cards. Video slots are empty ("🎬 Video coming soon"). |
