...
(function () {
  ...
  // Clicking the logo goes HOME, and home is the choice screen: where you are, one
  // button to continue building, and the docs. Not the board — dropping someone on
  // the full journey map when they only wanted the next step is a lot to take in.
